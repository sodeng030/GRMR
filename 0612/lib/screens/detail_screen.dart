...
class _DetailScreenState extends State<DetailScreen> {
  ...
  bool _isMyPost() {
    ...
    return widget.post.c_uid == uid ||
        widget.post.a1_uid == uid ||
        widget.post.a2_uid == uid ||
        widget.post.a3_uid == uid;
  }

  bool _isGenderBlocked() {
    final filter = widget.post.gender_filter;
    if (filter == 'all') return false;
    return filter != AppConfig.currentUserGender;
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: (_isJoining || _isMyPost() || _isGenderBlocked()) ? null : _joinPost,
                            child: _isJoining
                                ? const SizedBox(
                                    width: 32,
                                    height: 32,
                                ...
                                : Text(
                                    '갈래',
                                    style: TextStyle(
                                      color: (_isMyPost() || _isGenderBlocked())
                                          ? AppColors.textMain.withAlpha(60)
                                          : AppColors.textMain,
                                      fontSize: 32,
                                      fontFamily: 'RiaSans',
