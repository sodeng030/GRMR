...
class _RatingProfileScreenState extends State<RatingProfileScreen> {
  ...
  Future<void> _checkAlreadyRated() async {
    ...
    final key = 'rated_${AppConfig.currentUserUid}_${widget.targetUid}_${widget.postId}';
    setState(() {
                          ...
                          try {
                            ...
                            if (response.statusCode == 200 || response.statusCode == 201) {
                              ...
                              if (context.mounted) {
                                ...
                                Navigator.pop(context);  // RatingProfileScreen 닫고 CompletedPostDetailScreen으로 복귀
